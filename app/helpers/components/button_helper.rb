module Components::ButtonHelper
  ...
  def button_classes(classes = "", **options)
    class_variants("rounded font-semibold shadow-sm focus-visible:outline cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-50 #{classes}",
      variants: {
        size: {
        ...
        color: {
          ...
          "outline-light-gray": "bg-white border border-gray-300 text-gray-300 hover:border-gray-400 hover:text-gray-400",
